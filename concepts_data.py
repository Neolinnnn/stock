...
CONCEPTS: dict[str, list[tuple[str, str]]] = {
    "AI 伺服器": [
        ...
        ("3034", "聯詠"), ("2379", "瑞昱"), ("4938", "和碩"), ("2357", "華碩"),
    ],
    "CoWoS / 先進封裝": [
    ...
    "HBM / 記憶體": [
        ("2408", "南亞科"), ("2337", "旺宏"), ("2344", "華邦電"), ("3006", "晶豪科"),
        ("2451", "創見"), ("6770", "力積電"), ("8299", "群聯"), ("3532", "台勝科"),
        ("5269", "祥碩"), ("8150", "南茂"), ("8046", "南電"), ("5289", "宜鼎"),
        ("3205", "十銓"), ("3260", "威剛"),
    ],
    "Apple 供應鏈": [
    ...
    "封測": [
        ("3711", "日月光投控"), ("2449", "京元電子"), ("6239", "力成"),
        ("8150", "南茂"), ("6147", "頎邦"), ("6510", "精測"),
        ("2441", "超豐"), ("6257", "矽格"), ("3264", "欣銓"),
        ("2369", "菱生"), ("2329", "華泰"), ("6271", "同欣電"), ("2481", "強茂"),
    ],
    "IC 設計": [

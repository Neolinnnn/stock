...
SECTORS = {
    ...
    '記憶體': {
        ...
        '4967': '十銓', '3260': '威剛', '6770': '力積電',
        '8299': '群聯',
    },
    'AI伺服器': {
        '2317': '鴻海', '2382': '廣達', '3231': '緯創',
        '2376': '技嘉', '4938': '和碩', '2357': '華碩',
        '3665': '貿聯-KY',  # 產銷 55% HPC 資料中心線束/電源互連（自光通訊移入）
        '6278': '台表科',   # 伺服器/顯卡板卡 SMT 組裝（原小摩名單）
    },
    '封測': {
        ...
        # 2481 強茂已移除（2026-07）：功率元件 IDM 非封測代工，產業動能與 OSAT 不同步
    },
    '光學': {
        '3008': '大立光', '3406': '玉晶光',
    },
    'IC設計': {
        ...
        '6415': '矽力-KY', '5269': '祥碩', '2458': '義隆', '3014': '聯陽',
    },
    '車用電子': {
        '3552': '同致', '1533': '車王電', '2497': '怡利電',
    },
    '綠能環保': {
        '5292': '華懋',
    },
    ...
    # PCB 硬板/軟板製造（2026-07 解散小摩AI供應鏈後新設，臻鼎自 ABF載板移入：
    # 產銷以 FPC 軟板為主，ABF 載板僅其中一項）
    'PCB': {
        '4958': '臻鼎-KY', '6269': '台郡', '2313': '華通',
        '2367': '燿華', '5469': '瀚宇博', '3044': '健鼎',
        '3715': '定穎投控',
    },
    'AI ASIC/IP': {
    ...
    # 2026-07 新設：解散「小摩AI供應鏈」主題族群後，獨有個股依產業歸類
    '測試設備': {
        '2360': '致茂', '7769': '鴻勁',
    },
    '顯示': {
    ...
    # 「小摩AI供應鏈」已解散（2026-07）：主題與產業族群重疊 11 檔造成重複計算，
    # 獨有個股已分流至 PCB／銅箔CCL／被動元件／AI散熱／AI伺服器／測試設備／顯示
}
